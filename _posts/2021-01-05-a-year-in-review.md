...
The way this program worked (this was its last edition) is Google pairs with open-source organizations to welcome teenage contributors for a two-month period. At the end of these two months, each org picks two people who they deem made the most useful contributions during the period and were most dedicated to the organization.
...
Learning [Crystal](https://crystal-lang.org) has been a breeze coming from Ruby, and I truly recommend it as a more efficient alternative.

On the other hand, I've been a bit turned off of JavaScript and the Node.js runtime, not to mention its somewhat bloated package management system.
...
- Build a project related to ideas I have related to content discovery/consumption
...
- investigate compression of software packages
...
- Learning Haskell
- A Case for the Web
- Era of the Flashlights (???)
- How I view knowledge and its organization
...
- Cryptonomicon - Neal Stephenson [WWII] [Cryptography]
...
- A People's History of America - Howard Zinn [history]
- The Selfish Gene - Richard Dawkins [genetics and animal behavior]
- Speech and Language Processing - Dan Jurafsky and James H. Martin [NLP and AI]
